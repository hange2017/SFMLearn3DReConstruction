...
int main(int argc, char* argv[])
{
    ...
    tmp = (double)p1[0]*P1.row(2) - P1.row(0);
    A(0,0) = tmp(0);A(0,1) = tmp(1);A(0,2)=tmp(2);A(0,3)=tmp(3);
    tmp = (double)p1[1]*P1.row(2) - P1.row(1);
    A(1,0) = tmp(0);A(1,1) = tmp(1);A(1,2)=tmp(2);A(1,3)=tmp(3);
    tmp = (double)p2[0]*P2.row(2) - P2.row(0);
    A(2,0) = tmp(0);A(2,1) = tmp(1);A(2,2)=tmp(2);A(2,3)=tmp(3);
    tmp = (double)p2[1]*P2.row(2) - P2.row(1);
    A(3,0) = tmp(0);A(3,1) = tmp(1);A(3,2)=tmp(2);A(3,3)=tmp(3);
